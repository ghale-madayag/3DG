    ...
    if ("style" === n2)
      if ("string" == typeof e2)
        ...
        if ("string" == typeof r2 && (t2.style.cssText = r2 = ""), r2)
          for (n2 in r2)
            e2 && n2 in e2 || O(t2.style, n2, "");
        if (e2)
          for (n2 in e2)
            r2 && e2[n2] === r2[n2] || O(t2.style, n2, e2[n2]);
      }
    else if ("o" === n2[0] && "n" === n2[1])
      i2 = n2 !== (n2 = n2.replace(/Capture$/, "")), n2 = n2.toLowerCase() in t2 ? n2.toLowerCase().slice(2) : n2.slice(2), t2.l || (t2.l = {}), t2.l[n2 + i2] = e2, e2 ? r2 || t2.addEventListener(n2, i2 ? D : j, i2) : t2.removeEventListener(n2, i2 ? D : j, i2);
...
function R(t2, n2, e2, r2, o2, i2, u2, s2) {
  ...
  if (null === h2)
    ...
    if (function(t3, n3, e3, r3, o3) {
      var i3;
      for (i3 in e3)
        "children" === i3 || "key" === i3 || i3 in n3 || H(t3, i3, null, e3[i3], r3);
      for (i3 in n3)
        o3 && "function" != typeof n3[i3] || "children" === i3 || "key" === i3 || "value" === i3 || "checked" === i3 || e3[i3] === n3[i3] || H(t3, i3, n3[i3], e3[i3], r3);
    }(t2, d2, p2, o2, s2), f2)
      n2.__k = [];
    else if (_2 = n2.props.children, T(t2, Array.isArray(_2) ? _2 : [_2], n2, e2, r2, o2 && "foreignObject" !== h2, i2, u2, i2 ? i2[0] : e2.__k && P(e2, 0), s2), null != i2)
      for (_2 = i2.length; _2--; )
        null != i2[_2] && b(i2[_2]);
...
function Y(t2, n2) {
  ...
  if (t2.hasOwnProperty("constructor") && n2.hasOwnProperty("constructor") && t2.hasOwnProperty("props") && n2.hasOwnProperty("props") && t2.hasOwnProperty("key") && n2.hasOwnProperty("key") && t2.hasOwnProperty("ref") && n2.hasOwnProperty("ref") && t2.hasOwnProperty("type") && n2.hasOwnProperty("type"))
    return Y(t2.props, n2.props);
  var r2 = Object.keys(t2), o2 = Object.keys(n2);
  if (r2.length !== o2.length)
    return false;
  for (var i2 = 0, u2 = r2; i2 < u2.length; i2++) {
    var s2 = u2[i2];
    if (!n2.hasOwnProperty(s2) || !Y(t2[s2], n2[s2]))
      return false;
  }
  return true;
}
...
function tn(t2, n2, e2) {
  if (!t2.s) {
    if (e2 instanceof nn) {
      if (!e2.s)
        return void (e2.o = tn.bind(null, t2, n2));
      1 & n2 && (n2 = e2.s), e2 = e2.v;
    }
    if (e2 && e2.then)
      return void e2.then(tn.bind(null, t2, n2), tn.bind(null, t2, 2));
    t2.s = n2, t2.v = e2;
    var r2 = t2.o;
    r2 && r2(t2);
  }
...
var rn = function(t2) {
  ...
  return o2.clearCache = function() {
    ...
    if (this.findProcessorIndexByID(t3.id) > -1)
      throw Error("Processor ID " + t3.id + " is already defined");
                ...
                try {
                  for (; !(r3 = u4.next()).done; )
                    if ((e5 = n4(r3.value)) && e5.then) {
                      if (!en(e5))
                        return void e5.then(t6, i3 || (i3 = tn.bind(null, o4 = new nn(), 2)));
                      e5 = e5.v;
                    }
                  o4 ? tn(o4, 1, e5) : o4 = e5;
                } catch (t7) {
...
var yn = function(t2, n2, r2, o2) {
  return function(i2) {
    ...
    if (void 0 !== l2 ? r2 ? -1 === l2.direction ? p2 = true : d2 = true : 1 === a2 ? d2 = true : a2 > 1 && (f2 = true, c2 = true) : 0 === a2 ? c2 = true : a2 > 0 && !r2 ? (c2 = true, f2 = true) : a2 > 0 && r2 && (c2 = true), f2 && (s2 = []), c2)
      s2.push({ index: t2, direction: n2, compare: o2 });
    else if (d2) {
...
function wn(t2) {
  ...
  }, [l2]), w("button", { tabIndex: -1, "aria-label": o2("sort.sort" + (1 === u2 ? "Desc" : "Asc")), title: o2("sort.sort" + (1 === u2 ? "Desc" : "Asc")), className: rt(et("sort"), et("sort", function(t3) {
