        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box horizontal-logo">
            <Link href="/" class="logo logo-dark">
              ...
              <span class="logo-lg">
                <img src="@assets/images/logo-dark.webp" alt="" height="50">
              </span>
            </Link>
            ...
            <template #button-content>
              <span class="d-flex align-items-center">
                ...
                <span class="text-start ms-xl-2">
                  ...
                  <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ $page.props.roles.charAt(0).toUpperCase() }}{{ $page.props.roles.slice(1) }}</span>
                </span>
              </span>
            </template>
