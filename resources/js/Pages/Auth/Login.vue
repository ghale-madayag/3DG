                ...
                <BRow>
                    <BCol lg="12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-16 fw-medium">Create exceptional real estate developments that enrich <br> communities and exceed expectations.</p>
                        </div>
                    </BCol>
                </BRow>
                        ...
                        <BCard no-body class="mt-4">
                            ...
                            <BCardBody class="p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to 3DG Realty Development.</p>
                                </div>
                ...
                <BRow>
                    <BCol lg="12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} 3DG Realty Development.</p>
                        </div>
                    </BCol>
                </BRow>
            </BContainer>
