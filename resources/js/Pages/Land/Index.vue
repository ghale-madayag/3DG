...
<script setup>
    ...
    const formatData = land => {
        return land.map(land => [
            ...
            land.name,
            land.size +' '+'Sqm',
            land.ground_breaking,
            land.address ? land.address : ' ' + capitalizedString(land.barangay) +', '+capitalizedString(land.municipality)+', '+capitalizedString(land.province)+', '+land.region,
