<template>
    <Layout>
        ...
        <PageHeader title="Project List" pageTitle="Dashboard" />
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-auto">
                                <div class="d-flex flex-wrap align-items-start gap-2">
                                    ...
                                    <Link href="/project/create" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Add New</Link>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script setup>
    ...
    const formatData = project => {
        return project.map(project => [
           project.id,
           project.name,
           formatAddress(project.land),
           project.developer,
           project.total_units,
           formatCreatedAt(project.start_date),
           project.slug
        ]);
    };
    ...
    onMounted(() => {
        const formattedData = formatData(props.project);
    ...
    const selectAllRows = event => {
        ...
        selectedRows.value = isChecked ? props.project.map(project => project.id) : [];
    ...
    const editUrl = (row) => {
        router.visit('/project/'+row.cells[6].data+'/edit')
    }
