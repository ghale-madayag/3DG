<template>
    <Layout>
        ...
        <div class="text-center mb-3" v-show="property.data.length == 0">
            ...
            <div class="col" v-for="property in property.data">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <dl class="row mt-4" v-if="property.status !='Pending'">
                            ...
                            <dt class="col-sm-5" v-if="property.status !='Pending'" v-html="property.ledger ? 'Total Amount:' : 'Property Price:'"></dt>
                            <dd class="col-sm-7" v-if="property.status !='Pending'" v-html="property.ledger ? '₱ '+formatNumber(property.ledger.total_amount): '₱ '+formatNumber(property.total_price)"></dd>
                        </dl>
                    ...
                    <div class="card-footer border-top border-top-dashed" v-if="property.status !='Reserved' && property.status != 'Pending'">
                    ...
                    <div class="card-footer border-top border-top-dashed" v-else>                        
                        <p class="text-body mb-0" v-if="property.status !='Pending'"><i class="ri-time-line"></i> {{ property.due_in }}</p>
                    </div>
                </div>
            </div>
        </div>
